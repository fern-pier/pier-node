...
export const BusinessBorrowerRequest: core.serialization.ObjectSchema<
    serializers.BusinessBorrowerRequest.Raw,
...
export declare namespace BusinessBorrowerRequest {
    interface Raw {
