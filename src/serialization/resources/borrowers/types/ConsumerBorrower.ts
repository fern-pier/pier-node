...
export const ConsumerBorrower: core.serialization.ObjectSchema<
    serializers.ConsumerBorrower.Raw,
...
> = core.serialization.object({
    ...
    id: core.serialization.lazy(async () => (await import("../../..")).ConsumerBorrowerId),
...
export declare namespace ConsumerBorrower {
    interface Raw {
        address: serializers.Address.Raw;
        date_of_birth: string;
        id: serializers.ConsumerBorrowerId.Raw;
        email: string;
        first_name: string;
        last_name: string;
